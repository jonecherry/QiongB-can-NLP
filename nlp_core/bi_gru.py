...
print ('save model')
model.save('../data/model/bi-gru_cnv.best')
model = keras.models.load_model('../data/model/bi-gru_cnv.best')
from keras.utils import plot_model
plot_model(model, to_file='../data/network/bi-gru.png', show_shapes=True)
...
sample_submission.to_csv('../data/submission_bi-gru.csv', index=False)
